...
class Trainer:
    ...
    def __init__(self, network, x_train, t_train, x_test, t_test,
        ...
        self.add_image_num = add_image_num
    ...
    def train_step(self):
        ...
        # add
        x_batch, t_batch = data_augmentation(x_batch, t_batch, self.aug_params, self.add_image_num)
        # print("x_batch.shape=", x_batch.shape)
        # print("t_batch.shape=", t_batch.shape)
        ...
        if self.current_iter % self.iter_per_epoch == 0:
            ...
            # エポックごとにサンプル数を評価する
            # "not var is none" と "var is not none"は同じ
            # つまり、ここではevaluate_sample_num_per_epochに何かしら値が入っている場合、という意味
